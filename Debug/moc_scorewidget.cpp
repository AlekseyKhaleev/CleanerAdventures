...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ScoreWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ScoreWidget_t qt_meta_stringdata_ScoreWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ScoreWidget[] = {
...
Q_CONSTINIT const QMetaObject ScoreWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ScoreWidget.offsetsAndSizes,
    qt_meta_data_ScoreWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ScoreWidget_t,
        // Q_OBJECT / Q_GADGET
