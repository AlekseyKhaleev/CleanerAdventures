...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Maze_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Maze_t qt_meta_stringdata_Maze = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Maze[] = {
...
Q_CONSTINIT const QMetaObject Maze::staticMetaObject = { {
    ...
    qt_meta_stringdata_Maze.offsetsAndSizes,
    qt_meta_data_Maze,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Maze_t,
        // Q_OBJECT / Q_GADGET
